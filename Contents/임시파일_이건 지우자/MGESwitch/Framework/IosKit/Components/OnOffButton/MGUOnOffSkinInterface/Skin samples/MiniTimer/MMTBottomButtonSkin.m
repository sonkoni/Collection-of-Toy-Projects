//
//  MMTBottomButtonSkin.m
//  Copyright © 2022 Mulgrim Co. All rights reserved.
//

#import "MMTBottomButtonSkin.h"
...
@interface MMTBottomButtonSkin () <CAAnimationDelegate>
...
@implementation MMTBottomButtonSkin
...
- (void)setupOutContainer {
    ...
    UIColor *startColor = [UIColor colorWithRed:77.0/255.0 green:77.0/255.0 blue:77.0/255.0 alpha:1.0];
...
- (void)setupCenterContainer {
    CGRect frame =
    MGERectCenteredInRectSize(self.bounds, CGSizeMake(self.bounds.size.width * (36.0/38.0), self.bounds.size.height * (36.0/38.0)));
    ...
    [self.centerContainer.widthAnchor constraintEqualToAnchor:self.widthAnchor multiplier:(36.0/38.0)].active = YES;
    [self.centerContainer.heightAnchor constraintEqualToAnchor:self.heightAnchor multiplier:(36.0/38.0)].active = YES;
    self.centerContainer.backgroundColor = [UIColor colorWithRed:97.0/255.0 green:97.0/255.0 blue:97.0/255.0 alpha:1.0];
    ...
    UIColor *endColor = [UIColor colorWithWhite:0.0 alpha:0.2]; // 검정색 20%
    ...
    _innerShadowLayerC1 = [[MGEInnerShadowLayer alloc] initWithInnerShadowColor:[UIColor colorWithWhite:1.0 alpha:0.1].CGColor
    ...
    _innerShadowLayerC2 = [[MGEInnerShadowLayer alloc] initWithInnerShadowColor:[UIColor colorWithWhite:0.0 alpha:0.5].CGColor
                                                             innerShadowOffset:CGSizeMake(0.5, -0.5)
                                                         innerShadowBlurRadius:0.0];
