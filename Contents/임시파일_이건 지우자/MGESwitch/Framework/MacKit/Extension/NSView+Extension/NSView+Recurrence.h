...
@interface NSView (Recurrence)

- (NSArray<__kindof NSView *> *)mgrRecurrenceAllSubviews; // 자기자신을 포함한 모든 서브뷰
- (NSArray<__kindof NSView *> *)mgrRecurrenceAllSubviewsOfType:(Class)classObject; // Class에 해당하는 자기자신을 포함한 모든 서브뷰들의 배열

// MGAView *result = [self.view mgrRecurrenceSearchFirstSubviewOfType:[MGAView class]];
