...
@interface MGAStepperAnimationDecoView ()  <CAAnimationDelegate>
...
@implementation MGAStepperAnimationDecoView
...
#pragma mark - 생성 & 소멸
static void CommonInit(MGAStepperAnimationDecoView *self) {
