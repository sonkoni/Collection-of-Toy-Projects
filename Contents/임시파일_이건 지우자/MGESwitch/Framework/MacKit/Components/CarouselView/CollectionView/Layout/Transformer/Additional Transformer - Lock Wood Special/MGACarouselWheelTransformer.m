//
//  MGACarouselWheelTransformer.m
//  Copyright © 2022 Mulgrim Co. All rights reserved.
//

#import "MGACarouselWheelTransformer.h"
#import "MGACarouselCellLayoutAttributes.h"
#import "MGACarouselView.h"
#import "MGACarouselView_Internal.h"


#pragma mark - MGACarouselWheelTransformer
@interface MGACarouselWheelTransformer ()
@property (nonatomic, assign) CGFloat eyePosition;
@property (nonatomic, assign) BOOL inverted;
@end

@implementation MGACarouselWheelTransformer
...
- (void)applyTransformTo:(MGACarouselCellLayoutAttributes *)attributes {
    ...
    attributes.zIndex = (NSInteger)(attributes.position * 100);
