//
//  MGACarouselTimeMachineTransformer.m
//  Copyright © 2022 Mulgrim Co. All rights reserved.
//

#import "MGACarouselTimeMachineTransformer.h"
...
#pragma mark - MGACarouselViewTimeMachineTransformer
@interface MGACarouselTimeMachineTransformer ()
@property (nonatomic, assign) CGFloat eyePosition;
@property (nonatomic, assign) BOOL inverted;
@end

@implementation MGACarouselTimeMachineTransformer
...
//! MGACarouselCollectionViewLayout에서 이 값을 사용하지만, MGACarouselViewTimeMachineTransformer에서는 큰 의미가 없다.
...
- (void)applyTransformTo:(MGACarouselCellLayoutAttributes *)attributes {
    ...
    attributes.zIndex = (NSInteger)(position * 100);
