...
> ---|---
> `UITableViewStyleInsetGrouped` 사용시 앱이 **크래쉬** 됨 | 다음 세 가지 스타일 모두 정상적으로 작동함<br/><ul><li>[x] `UITableViewStylePlain`</li><li>[x] `UITableViewStyleGrouped`</li><li>[x] `UITableViewStyleInsetGrouped`</li></ul>
