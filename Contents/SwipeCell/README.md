...
> left, right actions based<br/>아랍어와 같이 RTL(right to left)방향으로 문자가<br/>쓰여지는 언어에서 적절하게 대응을 못함 | leading, trailing actions based
...
> left, right actions based | leading, trailing actions based
