...
#import "OutlineCollectionViewCell.h"
...
@interface ViewControllerA () <UICollectionViewDelegate, UICollectionViewDragDelegate, UICollectionViewDropDelegate>
...
- (void)configureCollectionView {
    ...
    [self.outlineCollectionView registerClass:[OutlineCollectionViewCell class]
                   forCellWithReuseIdentifier:[OutlineCollectionViewCell reuseIdentifer]];
...
- (void)configureDataSource {
    ...
    cellProvider:^UICollectionViewCell *(UICollectionView *collectionView, NSIndexPath *indexPath, MGROutlineItem <OutlineContent *>*outlineItem) {
        OutlineCollectionViewCell *cell =
        [collectionView dequeueReusableCellWithReuseIdentifier:[OutlineCollectionViewCell reuseIdentifer]
                                                  forIndexPath:indexPath];
        if ([cell isKindOfClass:[OutlineCollectionViewCell class]] == NO) {
...
didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (outlineItem.hasSubitem == YES) {
        ...
        OutlineCollectionViewCell *cell = (OutlineCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
        if ([cell isKindOfClass:[OutlineCollectionViewCell class]] == YES) {
...
- (NSArray<UIDragItem *> *)collectionView:(UICollectionView *)collectionView
    ...
    OutlineCollectionViewCell *cell = (OutlineCollectionViewCell *)[collectionView cellForItemAtIndexPath:path];
...
//    UICollectionViewCell *sourceCell = [collectionView cellForItemAtIndexPath:sourceIndexPath];
    OutlineCollectionViewCell *currentCell = (OutlineCollectionViewCell *)[collectionView cellForItemAtIndexPath:destinationIndexPath];
