...
//typedef NSString * MGRMainSection NS_STRING_ENUM;
static NSString *const section0  = @"section0";
...
@property (nonatomic, strong) UITableViewDiffableDataSource <MGRMainSection, MGROutlineItem <MGROutlineContent *>*>*dataSource;
@property (nonatomic, strong, readonly) NSDiffableDataSourceSnapshot <MGRMainSection, MGROutlineItem <MGROutlineContent *>*>*snapshotForCurrentState; // @dynamic
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSData *data =[NSKeyedArchiver archivedDataWithRootObject:item
                                            requiringSecureCoding:NO
                                                            error:nil];
        MGROutlineItem <MGROutlineContent *>*item2 = [NSKeyedUnarchiver unarchivedObjectOfClass:[MGROutlineItem class] fromData:data error:nil];
...
- (void)_commonInit {
    ...
    [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"Compositional Layout"] subitems:@[
        [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"Getting Started"] subitems:@[
            [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"List" viewControllerClass:classObjc]],
        ...
        [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"Advanced Layouts"] subitems:@[
            [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"Supplementary Views"] subitems:@[
                ...
                [MGROutlineItem outlineWithContentItem:[MGROutlineContent itemWithTitle:@"Pinnned Section Headers" viewControllerClass:classObjc]]]],
...
- (void)configureDataSource {
    ...
    [[UITableViewDiffableDataSource alloc] initWithTableView:self.outlineTableView
                                                cellProvider:^UITableViewCell *(UITableView *tableView,
                                                                                ...
                                                                                MGROutlineItem <MGROutlineContent *>*outlineItem) {
...
//        cell.accessoryType =  UITableViewCellAccessoryDetailDisclosureButton;
        if (@available(iOS 14, *)) {
            ...
            cell.textLabel.text = outlineItem.contentItem.title;
            cell.textLabel.font = [UIFont preferredFontForTextStyle:UIFontTextStyleHeadline];
            cell.textLabel.adjustsFontForContentSizeCategory = YES;
            // + preferredFontForTextStyle: 또는 + preferredFontForTextStyle:compatibleWithTraitCollection: 또는 UIFontMetrics에서 만들어진 font만이 adjustsFontForContentSizeCategory에 적용을 받을 수 있다.
        }
    ...
    NSDiffableDataSourceSnapshot <MGRMainSection, MGROutlineItem <MGROutlineContent *>*>*snapshot = [self snapshotForCurrentState];
...
- (NSArray <UIDragItem *>*)tableView:(UITableView *)tableView
    ...
    _initialDragCellFrame = [cell.contentView convertRect:cell.contentView.bounds toView:tableView];
    return @[dragItem];
//
...
dragPreviewParametersForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == self.outlineTableView) {
        ...
        MGROutlineCell *cell = (MGROutlineCell *)[tableView cellForRowAtIndexPath:indexPath];
        CGRect cellContainerViewFrame = [cell.contentView convertRect:cell.contentView.bounds toView:cell];
...
- (UITableViewDropProposal *)tableView:(UITableView *)tableView
    ...
    if (session.localDragSession != nil &&
        ...
        destinationIndexPath != nil) {  // 현재 collectionView 위에서 드래깅 되고 있을 때.
...
//    OutlineItem *finalFingerLocationOutlineItem = [self.dataSource itemIdentifierForIndexPath:finalFingerLocationIndexPath];
    ...
    if (coordinator.proposal.operation == UIDropOperationCopy) {
        ...
        [snapshot reloadItemsWithIdentifiers:@[sourceOutlineItem]];
...
//    UICollectionViewCell *sourceCell = [collectionView cellForItemAtIndexPath:sourceIndexPath];
    ...
    CGRect currentCellFrame = [currentCell.contentView convertRect:currentCell.contentView.bounds toView:tableView];
