...
static const MGREasingFunctionType easingFunctionType = MGREasingFunctionTypeEaseInOutCubic;
//static const MGREasingFunctionType easingFunctionType = MGREasingFunctionTypeEaseOutBounce;
...
- (void)genieTransitionWithDuration:(NSTimeInterval) duration
    ...
    for (int i = 0; i < totalFrame; i++) {
        ...
        if (axis == GenieAxisX) {
            firstCurveSegment.bPoint.y = MGREasingFunction(easingFunctionType,
                                                           curveProgress,
                                                           startLineSegment.aPoint.y,
                                                           endLineSegment.aPoint.y,
                                                           1.0);
            
            secondCurveSegment.bPoint.y = MGREasingFunction(easingFunctionType,
                                                            curveProgress,
                                                            startLineSegment.bPoint.y,
                                                            endLineSegment.bPoint.y,
                                                            1.0);
        } else {
            firstCurveSegment.bPoint.x  = MGREasingFunction(easingFunctionType,
                                                            curveProgress,
                                                            startLineSegment.aPoint.x,
                                                            endLineSegment.aPoint.x,
                                                            1.0);
            
            secondCurveSegment.bPoint.x = MGREasingFunction(easingFunctionType,
                                                            curveProgress,
        ...
        if (axis == GenieAxisX) {
            startPosition = MGREasingFunction(easingFunctionType,
                                              slideProgress,
