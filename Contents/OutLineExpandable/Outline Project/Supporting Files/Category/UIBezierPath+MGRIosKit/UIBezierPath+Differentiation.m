...
static NSMutableArray <NSValue *>* MGRCalculateAllPointsOnLine(CGPoint p1,
                                                               CGPoint p2,
                                                               MGRPathSegmentPointsAccuracy accuracy);
...
static NSMutableArray <NSValue *>* MGRCalculateAllPointsOnQuadBezier(MGRPathElementRef endPoint,
                                                                     MGRPathElementRef startPoint,
                                                                     MGRPathSegmentPointsAccuracy accuracy);
...
- (NSMutableArray <NSValue *>*)segmentPointsWithAccuracy:(MGRPathSegmentPointsAccuracy)accuracy {
    accuracy = MAX(MIN(accuracy, MGRPathSegmentPointsAccuracyHigh), MGRPathSegmentPointsAccuracyLow);
    
    //! 원본 베지어 패스에서 실제 구성된 앵커포인트와 성질을 추출한다.
    NSMutableArray <MGRPathElementRef>*pathElements = [self getAllPathElements];
