...
* @code
 NSArray <UIColor *>*minMaxColors = [self.mainColor colorsNearMainColorWithRange:@[@(0.1), @(0.07), @(0.03)]];
 @endcode
*/
- (NSArray <UIColor *>*)colorsNearMainColorWithRange:(NSArray <NSNumber *>*)range;
