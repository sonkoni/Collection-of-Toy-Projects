...
@interface MGRDisplayLink : NSObject

@property (nonatomic, assign) CFTimeInterval animationDuration;
@property (nonatomic, assign) MGREasingFunctionType easingFunctionType;
...
@interface MGRDisplayLinkGroup : NSObject
...
@property (nonatomic, strong) NSArray <NSNumber *>*easingFunctionTypes; // NSInteger, MGREasingFunctionType
 ...
 * @discussion MGRDisplayLink 를 연결하여 연속적으로 발동하게 만든 객체이다.
 * @remark - 기존의 MGRDisplayLink의 start progress 조정은 할 수 없게 되어있다. 무조건 0.0 에서 시작.
 * @code
    ...
    [MGRDisplayLinkGroup linkGroupWithDurations:@[@(0.3), @(0.3)]
                                         delays:@[@(0.0), @(0.3)]
                            easingFunctionTypes:@[@(MGREasingFunctionTypeEaseInBack), @(MGREasingFunctionTypeEaseInBack)]
                                 progressBlocks:@[progressBlock1, progressBlock2]
                                completionBlock:completionBlock];

    [self.displayLinkGroup startAnimation];
 * @endcode
 * @return 주어진 MGRDisplayLinkGroup 인스턴스를 반환한다.
*/
...
/* ----------------------------------------------------------------------
 * 2021-04-20 : MGRDisplayLinkGroup 추가
