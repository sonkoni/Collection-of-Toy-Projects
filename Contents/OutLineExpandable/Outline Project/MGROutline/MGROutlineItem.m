...
+ (instancetype)outlineWithContentItem:(id<NSSecureCoding>)contentItem
                              subitems:(NSArray <MGROutlineItem *>* _Nullable)subitems {
    return [[MGROutlineItem alloc] initWithContentItem:contentItem isFolder:YES subitems:subitems];
}

//! 폴더가 아닌 곳에서 사용.
+ (instancetype)outlineWithContentItem:(id<NSSecureCoding>)contentItem {
    return [[MGROutlineItem alloc] initWithContentItem:contentItem isFolder:NO subitems:nil];
}

//! 임시 루트.
+ (instancetype)tempRootWithSubitems:(NSArray <MGROutlineItem *>*)subitems {
    return [[MGROutlineItem alloc] initWithContentItem:tempRoot isFolder:YES subitems:subitems];
}
