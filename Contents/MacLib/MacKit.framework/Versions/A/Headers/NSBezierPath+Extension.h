...
*/
- (CGPathRef _Nullable)newMgrCGPath NS_SWIFT_UNAVAILABLE("func mgrCGPath() 를 대신 사용하라. 스위프트로 다시 만들었다.");
...
- (CGPathRef _Nullable)mgrCGPath NS_SWIFT_UNAVAILABLE("func mgrCGPath() 를 대신 사용하라. 스위프트로 다시 만들었다.");
