...
- (NSArray <NSLayoutConstraint *>*)mgrPinEdgesToSuperviewCustomMargins:(NSEdgeInsets)customMargins; // 인셋만큼 파고든다.
...
- (NSArray <NSLayoutConstraint *>*)mgrPinEdgesToSuperviewSafeAreaLayoutGuidesAndMargins;
