//
//  MGACarouselCenterExpandTransformer.h
...
#pragma mark - MGACarouselCenterExpandTransformer 클래스
@interface MGACarouselCenterExpandTransformer : MGACarouselTransformer
