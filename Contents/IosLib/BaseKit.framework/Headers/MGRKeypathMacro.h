...
#ifndef MGRKeypathMacro_h
#define MGRKeypathMacro_h
#import <Foundation/Foundation.h>
#import <BaseKit/MGRMetamacro.h>
...
NSString *result = @keypath(self.person, firstName); // ex) self 는 view controller
// => @"firstName"
