...
// 소괄호 분리
// NSString *string = @"111110(29292929%)"; => @[@"111110", @"29292929%"]
- (NSArray <NSString *>*)mgrParenthesisSeparation;
...
+ (NSString * _Nullable)mgrEUCKRCompatibleContentsOfFile:(NSString *)path
