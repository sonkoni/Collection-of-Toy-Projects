...
@property (nonatomic) UIColor *alertContainerViewBackgroundColor; // 디폴트 opaque white
//! 블러를 쓰고 싶다면, alertContainerViewBackgroundColor를 clear로 하면된다.
@property (nonatomic, assign) UIBlurEffectStyle blurEffectStyle; //! blur로 갈지 alertContainerViewBackgroundColor 쓸지 결정
