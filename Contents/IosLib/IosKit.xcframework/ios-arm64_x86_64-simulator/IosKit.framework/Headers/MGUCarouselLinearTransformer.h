//
//  MGUCarouselLinearTransformer.h
...
#pragma mark - MGUCarouselLinearTransformer 클래스
@interface MGUCarouselLinearTransformer : MGUCarouselTransformer
 ...
 * @code
    self.carouselView.transformer = [MGUCarouselLinearTransformer linearTransformerWithMinimumScale:0.6
                                                                                           MinimumAlpha:0.6
                                                                                              isRegular:NO
                                                                                                  ratio:0.2];
 * @endcode
 * @return 주어진 MGUCarouselLinearTransformer 인스턴스를 반환한다.
*/
...
//
//! [MGUCarouselLinearTransformer linearTransformerWithMinimumScale:0.6 MinimumAlpha:0.6 isRegular:NO ratio:0.2];
...
//
//! [MGUCarouselLinearTransformer linearTransformerWithMinimumScale:0.6 MinimumAlpha:0.6 isRegular:YES ratio:0.2];

// isRegular가 YES 일때, 단순히 minimumScale만 정해주고 적당히 간격을 유지하고 싶다면(줄어든 크기가 시각적으로 간격을 보여주는 형태)
//! [MGUCarouselLinearTransformer linearTransformerWithMinimumScale:minimumScale
//!                                                         MinimumAlpha:0.6
//!                                                           isRegular:YES
