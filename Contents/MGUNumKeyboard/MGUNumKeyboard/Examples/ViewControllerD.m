...
@interface ViewControllerD () <MGUNumKeyboardDelegate, UITextFieldDelegate>
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Layout Type - LowHeightStyle1";
    ...
    MGUNumKeyboard *keyboard = [[MGUNumKeyboard alloc] initWithFrame:CGRectZero
                                                              locale:nil
                                                          layoutType:MGUNumKeyboardLayoutTypeLowHeightStyle1
