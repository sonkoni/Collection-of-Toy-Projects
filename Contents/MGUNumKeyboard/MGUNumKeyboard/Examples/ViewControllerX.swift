...
final class ViewControllerA: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let stackView = textField.superview as? UIStackView {
            stackView.setCustomSpacing(50.0, after: textField)
        }
        
        navigationItem.title = "Layout Type - Standard1"
        ...
        keyboard.keyInput = textField // self.textField.inputView = keyboard; 이렇게 설정 금지.
    ...
    @objc private func textFieldDidChange(_ sender: UITextField) {
        ...
        if let subRange = sender.text?.range(of: ".") { // 존재한다면
...
extension ViewControllerA: MGUNumKeyboardDelegate {
