...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    */
    ...
    ((UIWindowScene *)scene).touchVisualizerEnabled = YES;
    LNTouchConfig *rippleConfig = [LNTouchConfig rippleConfig];
    rippleConfig.fillColor = [UIColor systemBlueColor];
    rippleConfig.strokeColor = [UIColor systemBlueColor];
    rippleConfig.alpha = 0.1;
    
    LNTouchConfig *contactConfig = [LNTouchConfig touchConfig];
    contactConfig.fillColor = [UIColor systemBlueColor];
    contactConfig.strokeColor = [UIColor systemBlueColor];
    contactConfig.alpha = 0.4;
    
    ((UIWindowScene *)scene).touchVisualizerWindow.touchRippleConfig = rippleConfig;
    ((UIWindowScene *)scene).touchVisualizerWindow.touchContactConfig = contactConfig;
    ((UIWindowScene *)scene).touchVisualizerWindow.morphEnabled = YES;
    ((UIWindowScene *)scene).touchVisualizerWindow.touchVisualizationEnabled = YES;
}
