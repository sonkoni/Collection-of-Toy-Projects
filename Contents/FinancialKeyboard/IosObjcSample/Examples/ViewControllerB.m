...
@interface ViewControllerB () <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (UIView *button in @[cell.minTextField, cell.tickModifyBtn, cell.minCheckBtn, cell.tickCheckBtn]) {
        button.tag = index;
    }
    return cell;
}
